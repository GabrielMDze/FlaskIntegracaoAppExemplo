...
public class ConsoleDetailActivity extends AppCompatActivity {
    ...
    private TextView textName, textYear, textPrice, textAtivo, textJogos;
    private long id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textJogos = findViewById(R.id.textJogos);
    }
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    textAtivo.setText(console.getAtivo());
                    textJogos.setText(String.valueOf(console.getQtnJogos()));
    ...
    public void deleteConsole(View view) {
        ...
        builder.setPositiveButton("SIM", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                String url = "http://10.0.2.2:5000/api/console/"+id;//10.0.2.2:5000
